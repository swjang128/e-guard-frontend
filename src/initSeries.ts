...
// Dashboard에 사용되는 기본적인 Option의 정의 - DonutChart
export const initDonutChartOptions = (
  height: number,
  colors: string[],
  labels: string[],
  annotations?: any
...
// Dashboard에 사용되는 기본적인 Option의 정의 - LevelRadialBarChart
export const initLevelRadialBarChartOptions = (
  height: number,
  colors: string[],
  labels: string[],
  level: string
...
// Dashboard에 사용되는 기본적인 Option의 정의 - MultiRadialBarChart
export const initMultiRadialBarChartOptions = (
  height: number,
  colors: string[],
  labels: string[]
): ApexOptions => {
