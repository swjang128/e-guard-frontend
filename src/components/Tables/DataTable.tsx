...
interface DataTableProps<T extends object> {
  ...
  useCustomDropdownEvents?: boolean;
  customDropdownEvents?: any[];
...
const DataTable = <T extends object>({
  ...
  onDelete,
  enableActions = false,
  useCustomDropdownEvents = false,
  customDropdownEvents = [],
        ...
        ...columns,
        {
          ...
          Cell: ({ row }: { row: any }) => (
            <div className="col-span-4 lg:col-span-2">
              {useCustomDropdownEvents
                ? customDropdownEvents && (
                    <CustomDropdown
                      events={customDropdownEvents.map((event) => {
                        return {
                          text: event.text,
                          func: () => event.func(row.original),
                        };
                      })}
                    />
                  )
