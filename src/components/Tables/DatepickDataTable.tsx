    ...
    <div className="data-table-common dark:border-strokedark dark:bg-boxdark">
      <div className="flex min-h-11 flex-col items-start gap-2 border-b border-stroke px-7 pb-4 dark:border-strokedark sm:flex-row sm:items-center sm:justify-between">
        ...
        <div
          ...
          } gap-2 ${title && `sm:ml-auto`} sm:flex-row sm:items-center`}
        >
          {selectedDates.length > 0 && (
            <>
              <input
                ...
                className="rounded border border-stroke px-4.5 py-2 outline-none focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary sm:mb-0"
                placeholder={t('Search...')}
              />
              <select
                value={pageSize}
                onChange={(e) => setPageSize(Number(e.target.value))}
                className="rounded border border-stroke px-2 py-2 focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary sm:mb-0"
              >
                {[5, 10, 20, 50].map((size) => (
          ...
          <button
            ...
            className={`border-e_green text-e_green hover:bg-e_green flex min-w-24 items-center gap-2 rounded border px-4 py-2 text-center font-medium hover:bg-opacity-90 hover:text-white dark:bg-primary dark:text-white xsm:max-w-1 md:max-w-40 ${
              (!selectedDates || selectedDates.length < 2) &&
              'disabled border-none bg-slate-200 text-zinc-100 hover:bg-slate-200 hover:text-zinc-100'
            }`}
          >
            <svg
