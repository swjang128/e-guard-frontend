...
export interface CustomDropdownEventsState {
  func: (item: any) => void;
  text: string;
}

interface CustomDropdownProps {
  events: CustomDropdownEventsState[];
}

const CustomDropdown: React.FC<CustomDropdownProps> = ({ events }) => {
  ...
  return (
    <div className="relative h-full">
      ...
      <div
        ...
        className={`shadow-12 absolute right-0 top-full z-1 mt-1 w-full max-w-39.5 rounded-[5px] bg-white py-2.5 dark:bg-boxdark ${
